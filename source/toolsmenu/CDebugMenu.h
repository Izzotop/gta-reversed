...
private:
    ...
    static int32_t m_missionToStartId;
    ...
    static void SpawnPed(int32_t modelID, CVector position);
    ...
    static bool StartMission(int32_t missionId, bool bDoMissionCleanUp = true);
