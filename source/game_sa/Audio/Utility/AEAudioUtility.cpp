...
int64_t &CAEAudioUtility::startTimeMs = *reinterpret_cast<int64_t *> (0xb610f8);
...
// 0x4d9e80
int64_t CAEAudioUtility::GetCurrentTimeInMilliseconds()
{
...
// 0x4d9ef0
uint32_t CAEAudioUtility::ConvertFromBytesToMS(uint32_t a, uint32_t frequency, uint16_t frequencyMult)
{
    return static_cast<uint32_t>(floorf(a / (frequency * frequencyMult / 500.0f)));
}

// 0x4d9f40
uint32_t CAEAudioUtility::ConvertFromMSToBytes(uint32_t a, uint32_t frequency, uint16_t frequencyMult)
{
