...
void CAEAudioHardware::PlaySound(short channel, uint16_t channelSlot, uint16_t soundIdInSlot, uint16_t bankSlot, short playPosition, short flags, float speed) {
