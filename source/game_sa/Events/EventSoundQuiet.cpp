...
CEventSoundQuiet::CEventSoundQuiet(CEntity* entity, float fLocalSoundLevel, uint32_t startTime, CVector& position)
{
...
CEventSoundQuiet* CEventSoundQuiet::Constructor(CEntity* entity, float fLocalSoundLevel, uint32_t startTime, CVector& position)
{
#ifdef USE_DEFAULT_FUNCTIONS
    return plugin::CallMethodAndReturn<CEventSoundQuiet*, 0x5E05B0, CEventSoundQuiet*, CEntity*, float, uint32_t, CVector&>
