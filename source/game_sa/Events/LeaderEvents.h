...
public:
    ...
    int32_t GetEventPriority() override  { return 46; }
...
public:
    ...
    int32_t GetEventPriority() override { return 47; }
    int32_t GetLifeTime() override { return 0; }
    bool AffectsPed(CPed* ped) override { return false; }
    bool AffectsPedGroup(CPedGroup* pedGroup) override;
    bool TakesPriorityOver(CEvent* refEvent) override { return true; }
...
public:
    ...
    int32_t GetEventPriority() override { return 48; }
    int32_t GetLifeTime() override { return 0; }
...
public:
    ...
    int32_t GetEventPriority() override { return 55; }
    int32_t GetLifeTime() override { return 0; }
