...
bool CPopulation::DoesCarGroupHaveModelId(int32_t carGroupId, int32_t modelId)
{
    return plugin::CallAndReturn<bool, 0x406F50, int32_t, int32_t>(carGroupId, modelId);
}
