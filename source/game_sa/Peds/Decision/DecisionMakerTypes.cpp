...
// 0x600860
void CDecisionMakerTypesFileLoader::GetPedDMName(int32_t index, char* name)
{
    plugin::Call<0x600860, int32_t, char*>(index, name);
}

// 0x600880
void CDecisionMakerTypesFileLoader::GetGrpDMName(int32_t index, char* name)
{
    plugin::Call<0x600880, int32_t, char*>(index, name);
}
...
// 0x6044C0
void CDecisionMakerTypes::AddEventResponse(int32_t decisionMakerIndex, int32_t eventType, int32_t taskId, float* responseChances, int32_t* flags)
{
    plugin::CallMethod<0x6044C0, CDecisionMakerTypes*, int32_t, int32_t, int32_t, float*, int32_t*>
        (this, decisionMakerIndex, eventType, taskId, responseChances, flags);
}

// 0x604490
void CDecisionMakerTypes::FlushDecisionMakerEventResponse(int32_t decisionMakerIndex, int32_t eventId)
{
    plugin::CallMethod<0x604490, CDecisionMakerTypes*, int32_t, int32_t>(this, decisionMakerIndex, eventId);
}
