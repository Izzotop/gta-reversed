...
class CStreaming {
public:
    static const int32_t TOTAL_SPECIAL_MODELS = 10;
    static const int32_t TOTAL_CLOTHES_MODELS = 10;
    static const int32_t TOTAL_CUTSCENE_MODELS = 20;
    static const int32_t SPECIAL_MODELS_RESOURCE_ID = 290;
    static const int32_t CLOTHES_MODELS_RESOURCE_ID = 384;
    static const int32_t CUTSCENE_MODELS_RESOURCE_ID = 300;
    ...
    static uint32_t& ms_nTimePassedSinceLastCopBikeStreamedIn;
    ...
    static int32_t* ms_NextPedToLoadFromGroup;
    ...
    static uint8_t** ms_pStreamingBuffer;
...
public:
    ...
    static bool AddToLoadedVehiclesList(int32_t modelId);
    ...
    static void DeleteRwObjectsBehindCamera(int32_t memoryToCleanInBytes);
    static bool DeleteRwObjectsBehindCameraInSectorList(CPtrList& list, int32_t memoryToCleanInBytes);
    static void DeleteRwObjectsInSectorList(CPtrList& list, int32_t sectorX, int32_t sectorY);
    static bool DeleteRwObjectsNotInFrustumInSectorList(CPtrList& list, int32_t memoryToCleanInBytes);
    static bool RemoveReferencedTxds(int32_t memoryToCleanInBytes);
    static void DisableCopBikes(bool bDisable);
    //! RandFactor : random number between 1-7
    static int32_t FindMIPedSlotForInterior(int32_t randFactor);
    ...
    static int32_t GetDefaultCabDriverModel();
    static int GetDefaultCopCarModel(int ignoreLvpd1Model);
    static int32_t GetDefaultCopModel();
    ...
    static bool HasSpecialCharLoaded(int32_t slot);
    static bool HasVehicleUpgradeLoaded(int32_t modelId);
    //! does nothing (NOP)
    ...
    static void LoadCdDirectory(const char* filename, int32_t archiveId);
    ...
    static void ProcessEntitiesInSectorList(CPtrList& list, float posX, float posY, float minX, float minY, float maxX, float maxY, float radius, int32_t streamingflags);
    static void ProcessEntitiesInSectorList(CPtrList& list, int32_t streamingFlags);
    ...
    static bool CarIsCandidateForRemoval(int32_t modelId);
    static bool RemoveLoadedVehicle();
    static bool ZoneModelIsCandidateForRemoval(int32_t modelId);
    ...
    static void RequestVehicleUpgrade(int32_t modelId, uint32_t streamingFlags);
