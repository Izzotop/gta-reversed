...
public:
    ...
    static CAnimBlock* GetAnimationBlock(int32_t animGroup) { return ms_aAnimAssocGroups[animGroup].m_pAnimBlock; }
    static uint32_t GetAnimationBlockIndex(uint32_t animGroup) { return GetAnimationBlock(animGroup) - ms_aAnimBlocks; }
    static CAnimBlock* GetAnimationBlock(char const* name);
    static uint32_t GetAnimationBlockIndex(char const* name);
