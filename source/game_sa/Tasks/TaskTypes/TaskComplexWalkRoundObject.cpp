...
CTaskComplexWalkRoundObject::CTaskComplexWalkRoundObject(int32_t moveState, CVector* targetPoint, CEntity* object)
{
...
CTaskComplexWalkRoundObject* CTaskComplexWalkRoundObject::Constructor(int32_t moveState, CVector* targetPoint, CEntity* object)
{
