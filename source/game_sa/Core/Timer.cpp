...
uint64_t& CTimer::m_snRenderStartTime = *(uint64_t*)0xB7CB38;
uint64_t& CTimer::m_snRenderPauseTime = *(uint64_t*)0xB7CB30;
...
uint64_t GetMillisecondTime() {
    return plugin::CallAndReturn<uint64_t, 0x5617C0>();
    // return RsTimer();
}
