...
struct tAtomicVisibilityPlugin {
    int16_t m_modelId;
    union {
        uint16_t m_flags; // eAtomicComponentFlag
        int16_t m_userValue;
    };
};
...
public:
    static const int32_t TOTAL_ALPHA_LISTS = 20;
    static const int32_t TOTAL_ALPHA_BOAT_ATOMIC_LISTS = 20;
    static const int32_t TOTAL_ALPHA_ENTITY_LISTS = 200;
    static const int32_t TOTAL_ALPHA_UNDERWATER_ENTITY_LISTS = 100;
    static const int32_t TOTAL_ALPHA_DRAW_LAST_LISTS = 50;
    static const int32_t TOTAL_WEAPON_PEDS_FOR_PC = 100;
    ...
    static int32_t& ms_atomicPluginOffset;
    static int32_t& ms_clumpPluginOffset;
    static int32_t& ms_framePluginOffset;
    ...
    static int32_t CalculateFadingAtomicAlpha(CBaseModelInfo* modelInfo, CEntity* entity, float distance);
    static void ClearAtomicFlag(RpAtomic* pRpAtomic, uint16_t flag);
    static RpAtomic* ClearAtomicFlagCB(RpAtomic* atomic, void* data);
    static void ClearClumpForAllAtomicsFlag(RpClump* pRpClump, uint16_t flag);
    ...
    static uint16_t GetAtomicId(RpAtomic* pRpAtomic);
    static CAtomicModelInfo* GetAtomicModelInfo(RpAtomic* pRpAtomic);
    static int32_t GetClumpAlpha(RpClump* pRpClump);
    ...
    static float GetDotProductWithCameraVector(RwMatrixTag* atomicMatrix, RwMatrixTag* clumpMatrix, uint16_t flags);
    static int32_t GetFrameHierarchyId(RwFrame* pRwFrame);
    static int16_t GetModelInfoIndex(RpAtomic* pRpAtomic);
    static int16_t GetUserValue(RpAtomic* pRpAtomic);
    static bool IsAtomicVisible(RpAtomic* pRpAtomic);
    static bool IsClumpVisible(RpClump* pRpClump);
    static void RenderAlphaAtomic(RpAtomic* atomic, int32_t alpha);
    ...
    static void RenderFadingAtomic(CBaseModelInfo* modelInfo, RpAtomic* atomic, int32_t alpha);
    static void RenderFadingClump(CBaseModelInfo* modelInfo, RpClump* clump, int32_t alpha);
    ...
    static void SetAtomicFlag(RpAtomic* pRpAtomic, uint16_t flag);
    static void SetClumpForAllAtomicsFlag(RpClump* pRpClump, uint16_t flag);
    static void SetAtomicId(void* pRpAtomic, int16_t id);
    ...
    static void SetFrameHierarchyId(RwFrame* pRwFrame, int32_t id);
