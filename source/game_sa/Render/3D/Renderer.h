...
extern int32_t MAX_INVISIBLE_ENTITY_PTRS; // default 150
extern int32_t MAX_VISIBLE_ENTITY_PTRS;   // default 1000
extern int32_t MAX_VISIBLE_LOD_PTRS;      // default 1000
extern int32_t MAX_VISIBLE_SUPERLOD_PTRS; // default 50

class CWorldScan {
public:
    using tScanFunction = void(__cdecl*)(int32_t, int32_t);
...
public:
    ...
    static void RequestObjectsInDirection(CVector const& posn, float angle, int32_t modelRequestFlags);
