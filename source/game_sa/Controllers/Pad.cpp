...
bool CPad::IsStandardKeyJustDown(uint8_t key)
{
    return plugin::CallMethodAndReturn<bool, 0x4D59B0, CPad*, uint8_t>(this, key);
}
...
bool CPad::IsStandardKeyPressed(uint8_t key)
{
...
// 0x4D59B0
bool CPad::isStandardKeyJustPressed(uint8_t key) {
    return NewKeyState.standardKeys[key] && !OldKeyState.standardKeys[key];;
}
